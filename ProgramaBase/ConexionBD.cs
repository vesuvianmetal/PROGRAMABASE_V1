    ...
    class ConexionBD
    {
        ...
        public static MySqlConnection ObtenerConexion()
        {
            try
            {
                ...
                MySqlConnection Conectar = new MySqlConnection("Server =localhost;port=3306; database = programabase ; Userid = root; password =; sslmode=none;Allow Zero Datetime=True;Convert Zero Datetime=True;");
                return Conectar;
            }
            catch
            {
